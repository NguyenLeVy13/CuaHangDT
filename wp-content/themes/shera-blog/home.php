...
$archive_column = get_theme_mod( 'dreshion_blog_blog_archive_column',2); 
?>
            ...
            <header class="page-header">
                <h2 class="page-title">
	            	...
	            	if ( dreshion_blog_is_latest_posts() ) {
	            		echo esc_html( get_theme_mod( 'dreshion_blog_your_latest_posts_title', esc_html__( 'Blogs', 'shera-blog' ) ) ); 
									    ...
									    <div class="shadow-entry-content">
									        <?php
												...
												if ( 'excerpt' == $archive_content_type ) {
											        ...
											        <div class="read-more-link">
													    <a href="<?php the_permalink(); ?>"><?php echo esc_html( get_theme_mod( 'dreshion_blog_archive_excerpt', esc_html__( 'View the post', 'shera-blog' ) ) ); ?></a>
													</div><!-- .read-more -->
												<?php
												} else {
													the_content( sprintf(
														wp_kses(
															...
															__( 'Continue reading<span class="screen-reader-text"> "%s"</span>', 'shera-blog' ),
															array(
																'span' => array(
																	'class' => array(),
																),
													...
													wp_link_pages( array(
														'before' => '<div class="page-links">' . esc_html__( 'Pages:', 'shera-blog' ),
														'after'  => '</div>',
													) );
												}
											?>
											<div class="entry-meta shadow-posted">
												...
												<div class="read-time">
													...
													echo '<span class="read-time-text">'. esc_html( get_theme_mod( 'dreshion_blog_min_to_read', esc_html__( 'Min', 'shera-blog' ) ) ). '</span>';
													?>
												</div>
											</div>
